...
Alpha Blog is a small Ruby on Rails Blogging Web Application where a registered user can write some blog post up to 300 characters, put it in the category and publish it.
